...
[
    ...
    },
    {
        ...
        "color": "#000000",
        "stroke": "#aaaaaa",
        "ontouchstart": "oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"C\");oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"O\");",
        "label":"Start",
			"isLocal": true,
    },
    {
        ...
        "color": "#000000",
        "stroke": "#aaaaaa",
        "ontouchstart": "oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"T\");oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"G\");oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"9\");",
...

    {
        ...
        "x": 0, "y": 0.27,
        "width": 1, "height": .1,
        "value": "Conversation.  When dancers walk on diag, go into leaves (kb)",
    },
    {
        "name": "moveAgain",
        "type": "Button",
        ...
        "color": "#000000",
        "stroke": "#aaaaaa",
        "ontouchstart": "oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"B\");oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"N\");",
        "label":"Activate swarms",
			"isLocal": true,
    },
    {
        "name": "moveAgain",
    ...
    },
    {
        ...
        "color": "#000000",
        "stroke": "#aaaaaa",
        "ontouchstart": "oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"M\");oscManager.sendOSC(\"/bobbevy/key\", \"s\", \"V\");",
